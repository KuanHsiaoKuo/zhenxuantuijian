...
class User(AbstractUser):
    ...
    # 可以为空
    qq = models.CharField(
        max_length=20, blank=True, null=True, verbose_name='QQ号码')
    # 不能重复
...
class Comment(models.Model):
    ...
    user = models.ForeignKey(
        User, blank=True, null=True, verbose_name='用户')
    article = models.ForeignKey(
        Article, related_name="entries", blank=True,
